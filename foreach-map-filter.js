...
function showFirstAndLast(arr){
    ...
    arr.forEach(function(str){
        ...
        let endLetter = str[endIndex];
        let beginLettter = str[0];

        newArr.push(`${beginLettter}${endLetter}`);
...
function vowelCount(str){
   ...
   let obj = {};
    ...
    strCharacters.forEach(function(letter){
...
in the array that has the same value as the second parameter or undefined if the value is not 
found in the array.
...
function doubleOddNumbers(arr) {
    ...
    let double = oddNums.map(function(val) {
            return val * 2;
        })
        return double;
}
